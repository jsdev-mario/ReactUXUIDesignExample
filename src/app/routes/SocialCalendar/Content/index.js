...
class SocialCalendarContent extends React.Component {
                ...
                <div className="container-fluid">
                    <div className="row"> 
                        <div className="col-12">
                            <h1>{<IntlMessages id="title_social_calendar_selectaccount"/>}</h1>
                        </div>
                                            ...
                                            },
                                            {
                                                ...
                                                Cell: data => (
                                                    <div className="col d-flex justify-content-center">
                                                        <div onClick={()=>{
                                                                this.props.history.push(`/socialcalendar/details/${data.row._original.id}`)
