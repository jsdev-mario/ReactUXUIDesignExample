...
class ManagePostsContent extends React.Component {
                ...
                <div className="container-fluid">
                    <div className="row"> 
                        <div className="col-12">
                            <h1>{<IntlMessages id="title_manageposts"/>}</h1>
                        </div>
                        <div className="col-12 card p-md-5 p-2">
                            ...
                            <div className="row">
                                <div className="col-md-3 offset-md-9">
                                    <Button onClick={() => {
                                        this.props.history.push('/manageposts/add');
                                    }} color="secondary" className="btn btn-block btn-lg">
                                        <i className=" zmdi zmdi-plus mr-3 font-weight-bold"></i>{<IntlMessages id="button_addpoststories"/>}
                                    </Button>
                                </div>
                            </div>
                            <div className="row">
                                            ...
                                            },
                                            {
                                                ...
                                                Cell: data => (
                                                    <div className="col d-flex justify-content-center">
                                                        <div onClick={()=>{
                                                                this.props.history.push(`/manageposts/details/${data.row._original.id}`)
