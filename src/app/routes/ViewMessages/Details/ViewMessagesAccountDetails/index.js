...
class ViewMessagesAccountDetails extends React.Component {
                    ...
                    <div className="row"> 
                        ...
                        <div className="col-12 card p-md-5 p-2">
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="form-group">
                                        <label htmlFor="messageType">{<IntlMessages id="label_messagetype"/>}:</label>
                                        <Textbox id="messageType" name="messageType" type="text" validate = {validate} value={messageType} 
                                ...
                                <div className="col-md-5">
                                    <div className="form-group">
                                        <label htmlFor="description">{<IntlMessages id="description"/>}:</label>
                                        <Textbox id="description" name="description" type="text" validate = {validate} value={description} 
                                ...
                                <div className="col-md-3">
                                    <div className="form-group">
                                        <label></label>
                                        <Button onClick={this.save} color="primary" className="btn btn-block btn-lg"><i className=" zmdi zmdi-search mr-3 font-weight-bold"></i><IntlMessages id="button_view"/></Button>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="text-center signup-text">
                                        <Link to={`${this.props.match.url.replace(`/viewmessagecontent/details/${this.state.id}`, '')}`} className="btn btn-outline-primary btn-lg btn-block">
